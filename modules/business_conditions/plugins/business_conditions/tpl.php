...
<style>
    .bussinessController .bussiness.nav>li>a, 
    .bussinessController .bussiness.nav>li>span {
        padding: 10px 10px;
        font-size: 13px;
        font-weight: bold;
    }
    .bussinessController .bussiness.nav-tabs>li {
        width: 33%;
        padding-left: 5px;
        text-align: left;
    }
    .bussinessController .bussiness.nav-tabs>li.active>a, 
    .bussinessController .bussiness.nav-tabs>li.active>a:focus, 
